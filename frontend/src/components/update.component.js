...
componentDidMount() {
  ...
  render() {
    return (
      <div>
       <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRfC9HqCsZ7qimLqu9SA-J5xzHhsQV1AEqxKe4Q4y68oxWLVC5f4c8NKrPcGOGTsOVGEw8&usqp=CAU" align="center" loading="lazy" alt="exicting" class="Cryicon" />
        <div class="alert alert-primary alert-deleted">        
          <strong> URL has been updated successfully ! </strong> 
          <br/><br/>
